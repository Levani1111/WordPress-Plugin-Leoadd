document.addEventListener('DOMContentLoaded', function (e) {
    const showAuthBtn = document.getElementById('leoadd-show-auth-form'),
        authContainer = document.getElementById('leoadd-auth-container'),
        close = document.getElementById('leoadd-auth-close'),
        authForm = document.getElementById('leoadd-auth-form'),
    ...
    authForm.addEventListener('submit', e => {
        ...
        let data = {
            ...
            nonce: authForm.querySelector('[name="leoadd_auth"]').value
        }
